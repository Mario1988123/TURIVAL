...
const TITULO_POR_RUTA: Array<{ test: (p: string) => boolean; titulo: string }> = [
  ...
  { test: (p) => p.startsWith('/configuracion/categorias'), titulo: 'Categorías de productos' },
  { test: (p) => p.startsWith('/configuracion/ubicaciones'), titulo: 'Ubicaciones' },
  { test: (p) => p.startsWith('/configuracion/tiempos'), titulo: 'Tiempos de proceso' },
